/**
 * Since this package has been published already on NPM before the GPR was a
 * thing, the package's json file will be altered before publishing to it.
 */
...
packageJson = JSON.stringify(package, null, 2);
