...
export default class Unity extends Component {
  ...
  _instantiate() {
    ...
    if (typeof this.props.loader === "undefined")
      error =
        "Please provide Unity with a path to the UnityLoader in the loader prop.";
    if (typeof this.props.src === "undefined")
      error =
        "Please provide Unity with a path to a valid JSON in the src prop.";
    ...
    return (
      <div className="unity" style={this._getContainerStyles()}>
        {this.state.error !== null ? (
          ...
          <div style={{ width: "100%", height: "100%" }} id="__ruw" />
        )}
      </div>
    );
  }
